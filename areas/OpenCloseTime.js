...
const OpenCloseTime = {
    canHandle(handlerInput) {
        // console.log("OpenCloseTime::",handlerInput.requestEnvelope.request.intent.name);
    ...
    handle(handlerInput) {
        console.log("OpenCloseTime Handler:: ", handlerInput);
        ...
        console.log("OpenCloseTime Handler:: currentIntent::" +currentIntent.name+" serviceType::" +serviceType);
