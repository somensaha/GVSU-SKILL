...
const GVSUFindInfo = {
    canHandle(handlerInput) {
        // console.log("GVSUFindInfo::",handlerInput.requestEnvelope.request.intent.name);
    ...
    handle(handlerInput) {
        console.log("GVSUFindInfo Handler:: ", handlerInput);
        ...
        console.log("GVSUFindInfo Handler:: currentIntent::" +currentIntent.name+" serviceType::" +serviceType);
