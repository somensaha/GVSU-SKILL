...
const GVSUServices = {
    canHandle(handlerInput) {
        // console.log("GVSUServices::",handlerInput.requestEnvelope.request.intent.name);
    ...
    handle(handlerInput) {
        console.log("GVSUServices Handler:: ", handlerInput);
        ...
        console.log("GVSUServices Handler:: currentIntent::" +currentIntent.name+" serviceType::" +serviceType);
