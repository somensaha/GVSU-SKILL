...
const GVSUPayment = {
    canHandle(handlerInput) {
        // console.log("GVSUPayment::",handlerInput.requestEnvelope.request.intent.name);
    ...
    handle(handlerInput) {
        console.log("GVSUPayment Handler:: ", handlerInput);
        ...
        console.log("GVSUPayment Handler:: currentIntent::" +currentIntent.name+" serviceType::" +serviceType);
