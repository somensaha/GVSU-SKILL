...
const IntentWithCategories = {
    canHandle(handlerInput) {
        // console.log("IntentWithCategories::",handlerInput.requestEnvelope.request.intent.name);
        // console.log("type::",handlerInput.requestEnvelope.request.type);
        return handlerInput.requestEnvelope.request.type === 'IntentRequest' 
            && handlerInput.requestEnvelope.request.intent.name === 'IntentWithCategories';
    },
    handle(handlerInput) {
        console.log("IntentWithCategories Handler:: ", handlerInput);
        ...
        console.log("IntentWithCategories Handler:: currentIntent::" +currentIntent.name+" serviceType::" +serviceType);
