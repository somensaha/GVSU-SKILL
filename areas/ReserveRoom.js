...
const ReserveRoom = {
    canHandle(handlerInput) {
        // console.log("ReserveRoom::",handlerInput.requestEnvelope.request.intent.name);
        // console.log("type::",handlerInput.requestEnvelope.request.type);
        return handlerInput.requestEnvelope.request.type === 'IntentRequest' 
            && handlerInput.requestEnvelope.request.intent.name === 'ReserveRoom';
    },
    handle(handlerInput) {
        console.log("ReserveRoom Handler:: ", handlerInput);
        ...
        console.log("ReserveRoom Handler:: currentIntent::" +currentIntent.name+" serviceType::" +serviceType);
