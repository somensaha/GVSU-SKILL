...
const PaymentLocation = {
    canHandle(handlerInput) {
        // console.log("PaymentLocation::",handlerInput.requestEnvelope.request.intent.name);
    ...
    handle(handlerInput) {
        console.log("PaymentLocation Handler:: ", handlerInput);
        ...
        console.log("PaymentLocation Handler:: currentIntent::" +currentIntent.name+" serviceType::" +serviceType);
