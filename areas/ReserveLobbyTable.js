...
const ReserveLobbyTable = {
    canHandle(handlerInput) {
        // console.log("ReserveLobbyTable::",handlerInput.requestEnvelope.request.intent.name);
        // console.log("type::",handlerInput.requestEnvelope.request.type);
        return handlerInput.requestEnvelope.request.type === 'IntentRequest' 
            && handlerInput.requestEnvelope.request.intent.name === 'ReserveLobbyTable';
    },
    handle(handlerInput) {
        console.log("ReserveLobbyTable Handler:: ", handlerInput);
        ...
        console.log("ReserveLobbyTable Handler:: currentIntent::" +currentIntent.name+" serviceType::" +serviceType);
