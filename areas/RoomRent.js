...
const RoomRent = {
    canHandle(handlerInput) {
        ...
        return handlerInput.requestEnvelope.request.type === 'IntentRequest' 
            && handlerInput.requestEnvelope.request.intent.name === 'RoomRent';
    },
    handle(handlerInput) {
        console.log("RoomRent Handler:: ", handlerInput);
        ...
        console.log("RoomRent Handler:: currentIntent::" +currentIntent.name+" serviceType::" +serviceType);
