...
const GVSUOrientationTime = {
    canHandle(handlerInput) {
        // console.log("GVSUOrientationTime::",handlerInput.requestEnvelope.request.intent.name);
        // console.log("type::",handlerInput.requestEnvelope.request.type);
        return handlerInput.requestEnvelope.request.type === 'IntentRequest' 
            && handlerInput.requestEnvelope.request.intent.name === 'GVSUOrientationTime';
    },
    handle(handlerInput) {
        console.log("GVSUOrientationTime Handler:: ", handlerInput);
        ...
        console.log("GVSUOrientationTime Handler:: currentIntent::" +currentIntent.name+" serviceType::" +serviceType);
